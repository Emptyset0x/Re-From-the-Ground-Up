...
import rftgumod.api.util.predicate.ItemCompound;
import rftgumod.api.util.predicate.ItemIngredient;
...
public class StackUtils implements IStackUtils {
    ...
    public ItemStack getParchment(ITechnology tech, Parchment type) {
        ...
        getItemData(stack).setString("RFTGU", tech.getRegistryName().toString());
        return stack;
    }
